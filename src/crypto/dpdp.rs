...
pub fn hash_to_g1(message: &[u8]) -> G1Projective {
    let _span = flamegraph::span(["dPDP", "hash_to_g1"]);
...
impl DPDP {
    ...
    pub fn key_gen() -> DPDPParams {
        let _span = flamegraph::span(["dPDP", "key_gen"]);
    ...
    pub fn tag_file(params: &DPDPParams, file_chunks: &[Vec<u8>]) -> DPDPTags {
        let span = flamegraph::span(["dPDP", "tag_file"]);
    ...
    pub fn gen_chal(
        ...
        let span = flamegraph::span(["dPDP", "gen_chal"]);
        if tags.is_empty() {
            return Vec::new();
        }
        let n = tags.tags.len();
    ...
    pub fn gen_contributions(
        ...
        let span = flamegraph::span(["dPDP", "gen_contributions"]);
        let order = curve_order();
    ...
    pub fn gen_proof(
        ...
        let span = flamegraph::span(["dPDP", "gen_proof"]);
        let order = curve_order();
    ...
    pub fn check_proof(
        ...
        let _span = flamegraph::span(["dPDP", "check_proof"]);
    ...
    pub fn check_proof_with_relaxed(
        ...
        let span = flamegraph::span(["dPDP", "check_with_relaxed"]);
    ...
    pub fn verify_with_merkle(
        ...
        let span = flamegraph::span(["dPDP", "verify_with_merkle"]);
        let order = curve_order();
